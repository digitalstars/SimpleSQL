...
class Parser {
    ...
    /**
     * @param string $query - строка запроса с заполнителями
     * @param array $args - аргументы для заполнителей
     * @return string|null
     * @throws Exception
     */
    public function parse(string $query, array $args) {
        $this->is_inner = false;
